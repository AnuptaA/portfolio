...
<div class="bg-primary card-glow overflow-hidden rounded-2xl shadow-md transition-all duration-500">
	<div class="image-container relative w-full overflow-hidden">
		...
		{#if projectLink !== '' && projectLink !== 'Deprecated'}
		...
		{:else}
			<div class="relative z-10 block h-full w-full">
				<img
					src={imageUrl}
					alt="Project screenshot"
					class="h-full w-full object-cover object-center transition-transform duration-300 hover:scale-105"
	...
	<div class="p-6">
		<div class="mb-3 flex items-center justify-between">
			<h3 class="text-dark hover:text-accent text-2xl font-bold transition-colors">
				{title}
			</h3>
